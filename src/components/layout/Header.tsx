    ...
    >
      <div className="w-full flex items-center justify-between px-6 sm:px-8 md:px-10 lg:px-12">
        ...
        <nav className="hidden md:flex items-center space-x-7 text-white">
          ...
          <Link 
            href="/disclosures" 
            className="text-sm text-white/80 hover:text-[#E3B23C] transition-colors duration-300"
          >
            Disclosures
          </Link>
          ...
          <div className="flex flex-col space-y-4 font-sans">
            {["Mission", "Learn", "Grow", "Plan", "Reviews", "Media", "Team", "Contact"].map((item, i) => (
              <Link 
                key={item} 
                href={`/${item.toLowerCase()}`} 
                className="text-gray-700 hover:text-[#E3B23C] font-medium transform hover:translate-x-1 transition-all duration-200"
            ...
            <Link 
              href="/disclosures" 
              className="text-sm text-gray-500 hover:text-[#E3B23C] transform hover:translate-x-1 transition-all duration-200"
              onClick={() => setIsMenuOpen(false)}
            >
              Disclosures
            </Link>
