...
export function CarouselContainer({
  ...
  return (
    <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
      ...
      {/* Navigation Buttons */}
      <div className="flex justify-between items-center p-4 bg-gray-700/50 border-t border-gray-700">
        <button
          onClick={onPrev}
          disabled={currentSlide === 0}
          className="px-4 py-2 text-gray-300 font-medium rounded-lg hover:bg-gray-700 hover:scale-105 disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:scale-100 transition-all duration-300 ease-out flex items-center gap-2 shadow-sm hover:shadow-md"
          style={{
        ...
        <div className="text-sm text-gray-400 font-medium transition-all duration-300">
          {currentSlide + 1} / {totalSlides}
        </div>

        <button
          onClick={onNext}
          className="px-6 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-semibold rounded-lg hover:from-cyan-700 hover:to-blue-700 hover:scale-105 hover:shadow-lg transition-all duration-300 ease-out flex items-center gap-2 shadow-md"
          style={{
