...
const InvestmentOptions = () => {
  ...
  return (
    <section className="py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-6 lg:gap-12">
        {/* Left side - Title and image */}
        <div className="lg:w-2/5">
          <h2 className="text-3xl md:text-4xl font-sans font-medium text-[#1A3A5F] mb-6">
            Why Clockwise?
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-[#1A3A5F] to-[#1FAAA3] rounded-full mb-6"></div>
          ...
          <div className="relative mx-auto lg:mx-0 w-56 h-56 md:w-64 md:h-64">
            ...
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-12 h-12 bg-white rounded-full border border-gray-200 shadow-md flex items-center justify-center">
            ...
            <div className="absolute top-1/2 -right-4 -translate-y-1/2 w-12 h-12 bg-white rounded-full border border-gray-200 shadow-md flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="#1A3A5F">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
            </div>
            
            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-12 h-12 bg-white rounded-full border border-gray-200 shadow-md flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="#1A3A5F">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" />
              </svg>
            </div>
            
            <div className="absolute top-1/2 -left-4 -translate-y-1/2 w-12 h-12 bg-white rounded-full border border-gray-200 shadow-md flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="#1A3A5F">
            ...
            {investmentOptions.map((option) => (
              <div key={option.id} className="border-b border-gray-200">
                <button
                  ...
                  className="w-full py-3 flex items-start justify-between text-left focus:outline-none"
                >
